...
$json_text = _OO_JSON_Read_File("json2.txt")

$jsonPath_text = _OO_JSON_Read_File("jsonpath-0.8.0.js")

$Objectkeys_polyfill_text = _OO_JSON_Read_File("Keys_polyfill.txt") ; scripting object dosen't have a keys function.
